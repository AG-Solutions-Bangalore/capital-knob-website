...
const TITLE_BY_HREF: Record<string, string> = {
  ...
  '/solutions': 'Financial Services – CapitalKnob',
  '/solutions#home-loans': 'Home Loan Services – CapitalKnob',
  ...
  '/solutions#individuals': 'Financing Services for Individuals – CapitalKnob',
