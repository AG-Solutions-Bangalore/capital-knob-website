...
export const individualsCards: ServiceCard[] = [
  {
    ...
    iconKey: 'home',
    art: 'homeLoans',
    imageSrc: `${IMAGE_BASE_URL}/solutions/card_home_loans.webp`,
  ...
  },
  {
    ...
    iconKey: 'refresh',
    art: 'balanceTransfer',
    imageSrc: `${IMAGE_BASE_URL}/solutions/card_balance_transfer.webp`,
  ...
  },
  {
    ...
    iconKey: 'stack',
    art: 'topUp',
    imageSrc: `${IMAGE_BASE_URL}/solutions/card_top_up.webp`,
  ...
  },
  {
    ...
    iconKey: 'crane',
    art: 'construction',
    imageSrc: `${IMAGE_BASE_URL}/solutions/card_construction.webp`,
  ...
  },
  {
    ...
    iconKey: 'document',
    art: 'loanAgainst',
    imageSrc: `${IMAGE_BASE_URL}/solutions/card_loan_against.webp`,
...
export const businessesCards: ServiceCard[] = [
  {
    ...
    iconKey: 'chart',
    art: 'workingCapital',
    imageSrc: `${IMAGE_BASE_URL}/solutions/card_working_capital.webp`,
    imageTitle: 'Working Capital Finance – CapitalKnob',
  ...
  },
  {
    ...
    iconKey: 'briefcase',
    art: 'businessLoans',
    imageSrc: `${IMAGE_BASE_URL}/solutions/card_business_loans.webp`,
    imageTitle: 'Business Loans – CapitalKnob',
  ...
  },
  {
    ...
    iconKey: 'shield',
    art: 'secured',
    imageSrc: `${IMAGE_BASE_URL}/solutions/card_secured_loans.webp`,
    imageTitle: 'Secured Business Loans – CapitalKnob',
  ...
  },
  {
    ...
    iconKey: 'trendUp',
    art: 'expansion',
    imageSrc: `${IMAGE_BASE_URL}/solutions/card_expansion.webp`,
    imageTitle: 'Business Expansion Funding – CapitalKnob',
...
export const otherCapitalCards: ServiceCard[] = [
  {
    ...
    iconKey: 'building',
    art: 'realEstate',
    imageSrc: `${IMAGE_BASE_URL}/solutions/card_real_estate.webp`,
    imageTitle: 'Real Estate Finance – CapitalKnob',
  ...
  },
  {
    ...
    iconKey: 'handshake',
    art: 'privateCredit',
    imageSrc: `${IMAGE_BASE_URL}/solutions/card_private_credit.webp`,
    imageTitle: 'Private Credit – CapitalKnob',
    href: '/private-credit',
  },
  {
    id: 'growth-capital',
    ...
    iconKey: 'plant',
    art: 'growthCapital',
    imageSrc: `${IMAGE_BASE_URL}/solutions/card_growth_capital.webp`,
    imageTitle: 'Growth Capital – CapitalKnob',
  ...
  },
  {
    ...
    iconKey: 'network',
    art: 'capitalConnect',
    imageSrc: `${IMAGE_BASE_URL}/solutions/card_capital_connect.webp`,
    imageTitle: 'Capital Connect – CapitalKnob',
    href: '/contact',
  },
]
